...
class CreateProduct extends Component {
  ...
  onCreateMessage = (authUser) => {
    // const { isPizza, isDrink, isBurger, isPasta } = this.state;
    // const roles = {};
    //
    // if (isPizza) {
    //   roles[ROLES.PIZZA] = ROLES.PIZZA;
    // }else if(isDrink){
    //   roles[ROLES.DRINK] = ROLES.DRINK;
    // }else if(isBurger){
    //   roles[ROLES.BURGERS] = ROLES.BURGERS;
    // }else if(isPasta){
    //   roles[ROLES.PASTAR] = ROLES.PASTAR;
    // }
  ...
  render() {
    const { isPizza, isDrink, isBurger, isPasta, namedish, price, title } = this.state;
